              ...
              >
                {chain.hasIcon && chain.iconUrl && (
                  <img
                    ...
                    src={chain.iconUrl}
                    style={{ width: 16, height: 16, borderRadius: 999, marginRight: 4 }}
                  />
                )}
                {chain.name}
              </button>
              <div className='flex items-center gap-1 pl-2 rounded-md  bg-white '>
                  <span className='text-blue-500 mr-4 inline-block'>
                   ...
                   <button
                      ...
                      className=" flex justify-between item-center px-3 py-1 bg-gray-200 border border-gray-300 rounded-md text-sm text-red-500"
                    >
                      {account.displayName}
                    </button>
                    </div>
